        ...
        <Tabs.Screen
          ...
          options={({ route }) => ({
            ...
            tabBarButton: (props) => (
              <TouchableOpacity
                onPress={openModal}
                className='h-20 w-20 bg-pastel-black items-center justify-center rounded-full absolute top-[-50] border-4 border-white'
              >
          ...
          <View className='w-[80%] bg-white rounded-[10px] px-8 '>
            <View className='my-5' style={{ gap: 10 }}>
              <Text className='font-pRegular text-[12px]'>
                You are about to begin the scanning process
              </Text>
              <TouchableOpacity
