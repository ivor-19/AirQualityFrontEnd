...
const TabLayout = () => {
  return (
   <Tabs screenOptions={{tabBarStyle: {height: 70, backgroundColor: '#1d1c1a'}, tabBarLabelStyle: {margin: 6},tabBarItemStyle: {padding: 12}, tabBarActiveTintColor: '#fff',  tabBarInactiveTintColor: '#d1d5db', tabBarHideOnKeyboard: true,}}>
    <Tabs.Screen 
        name='(homeTab)'
        options={{
            headerShown: false,
