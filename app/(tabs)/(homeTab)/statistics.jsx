        ...
        <ScrollView contentContainerStyle={{}}>
            <View className='h-full w-full p-4' style={{gap: 12}}>
                <View className='h-32 flex flex-row space-x-2'>
                    <View className='bg-pastel-green h-full w-[40%] rounded-custom items-center justify-center p-4' style={{shadowColor: 'gray', elevation: 4}}>
                        <Text className='font-pBold text-[24px]'>240</Text>
                    ...
                    <View className='bg-white h-full flex-1 rounded-custom p-4 border-2 border-gray-100' style={{shadowColor: 'gray', elevation: 4}}>
                        <View className='flex-row items-center' style={{gap: 4}}>
                            ...
                            <View className='h-[6px] w-[6px] bg-red-500 rounded-full'></View>
                            <Text className='font-pSemiBold text-[10px]'>High</Text>
                        </View>
                        <View className='flex-row' style={{gap: 4}}>
                            <Text className='font-pRegular text-[10px]'>Condition: </Text>
                            <Text className='font-pSemiBold text-[10px]'>Severe</Text>
                        </View>
                        <ScrollView>
                ...
                <View className='w-full flex-1 flex flex-col space-y-2'>
                    <View className='bg-pastel-green h-24 rounded-custom p-4 flex-row items-center'>
                        <View className='w-[20%] h-10 items-center justify-center'>
                            ...
                            <Text className='text-pastel-black font-pRegular text-[10px]'>PM 2.5</Text>
                        </View>
                        <View className='flex-1 h-full px-2'>
                            <Text className='font-pBold text-pastel-black text-[16px]'>Particulate Matter 2.5</Text>
                            <Text className='font-pRegular text-pastel-black text-[10px]'>Time Scanned: --</Text>
                    ...
                    <View className='bg-pastel-green h-24 rounded-custom p-4 flex-row items-center'>
                        <View className='w-[20%] h-10 items-center justify-center'>
                            <Text className='text-pastel-black font-pBold text-[30px]'>60</Text>
                            <Text className='text-pastel-black font-pRegular text-[10px]'>CO2</Text>
                        </View>
                        <View className='flex-1 h-full px-2'>
                            <Text className='font-pBold text-pastel-black text-[16px]'>Carbon Dioxide</Text>
                            <Text className='font-pRegular text-pastel-black text-[10px]'>Time Scanned: --</Text>
                            <Text className='font-pRegular text-pastel-black text-[10px]'>Risk Indicator: --</Text>
                        </View> 
                        <View className='w-[20%] h-full items-center justify-center'>
                    ...
                    <View className='bg-pastel-green h-24 rounded-custom p-4 flex-row items-center'>
                        <View className='w-[20%] h-10 items-center justify-center'>
                            <Text className='text-pastel-black font-pBold text-[30px]'>24</Text>
                            <Text className='text-pastel-black font-pRegular text-[10px]'>NO2</Text>
                        </View>
                        <View className='flex-1 h-full px-2'>
